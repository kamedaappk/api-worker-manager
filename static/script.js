            ...
            if (data.workers && Array.isArray(data.workers)) {
                data.workers.forEach((worker) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td><input type="number" value="${worker.frequency}" ${worker.status === "running" ? "disabled" : ""} onchange="updateWorker('${worker.id}', 'frequency', this.value)"></td>
                        <td><input type="number" value="${worker.total_calls}" ${worker.status === "running" ? "disabled" : ""} onchange="updateWorker('${worker.id}', 'total_calls', this.value)"></td>
